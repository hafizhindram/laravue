        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <router-link to="/dashboard" class="nav-link">
              <i class="nav-icon fas fa-home icon-blue"></i>
              <p>
                Dashboard
              </p>
            </router-link>
          ...
          <li class="nav-item">
            <router-link to="/profile" class="nav-link">
              <i class="nav-icon fas fa-user icon-yellow"></i>
              <p>
                Profile
              </p>
            </router-link>
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link{{--  active --}} {{-- {{ Request::is('/') ? "active" : "" }} --}}">
              <i class="nav-icon fas fa-cog icon-orange"></i>
              <p>
                Management
